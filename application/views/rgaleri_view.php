<?php
if($_SERVER['PHP_SELF']!="".base_url()."application/views/rgaleri_view.php"){
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="kpla panel-heading">Resim galeri</div>
<ul class="list-inline galeri">
<?php foreach($resimg as $galeri){ ?>
...
<a class="galericek btn btn-default col-md-12">Diğerlerini gör</a>
</div>
<!--Ana sayfa bitiş-->
