<?php
if($_SERVER['PHP_SELF']!="".base_url()."application/views/resimview.php"){
?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/galeri.js"></script>
	<title><?php echo $gbilgi["baslik"]; ?></title>
</head>
<body>
<div class="container-fluid">
<link rel='stylesheet' type="text/css" href="<?php echo base_url(); ?>assets/css/yazi.css" />
<link rel='stylesheet' type="text/css" href="<?php echo base_url(); ?>assets/css/resimgaleri.css" />
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/resimgaleri.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/bootstrap.min.js"></script>
<div class="col-md-9 panel panel-default">
<div class="kl panel-heading"><h3 class="panel-title"><?php echo $gbilgi["baslik"]; ?></h3></div>
<div class="panel-body">
<span id="solicon" class="glyphicon glyphicon-chevron-left"></span>
<ul class="list-inline resimgaleri">

<?php foreach($gelen as $galeri){ ?>
<li id="0"><div class="col-md-12 resimalani">
<img src='<?php echo $galeri["resimurl"]; ?>' width='100%' height='100%'>
</div>
<br>
<div class="col-md-12 alt">
<blockquote><?php echo $galeri["aciklama"]; ?></blockquote>
</div></li>
<?php } ?>

</ul>
<span id="sagicon" class="glyphicon glyphicon-chevron-right"></span>


<div class="panel panel-default col-md-6">

<div class="gns panel-heading"><?php echo $gbilgi["baslik"]; ?> adlı galeriyi nasıl buldunuz ?</div>
<div class="panel-body">
...
<?php
if($islemkontrol){
  echo "Daha önce bu galeriyi oyladınız";
  echo "<div class='col-md-12 alert alert-warning'>Bu galeriyi daha önce".$iyisayi." kişi iyi ve ".$kotusayi." kişi kötü buldu</div>";
...
<form action="gislem" method="post" id="islemform">
<input type="hidden" name="galeriid" value="<?php echo $gbilgi["id"]; ?>" />
<input type="hidden" name="durum" value="1" />
<input id="islem"  type="button" class="col-md-6 btn btn-success" name="iyi" value="İyi buldum" />
</form>
<form action="gislem" method="post" id="islemform2">
<input type="hidden" name="galeriid" value="<?php echo $gbilgi["id"]; ?>" />
...
<div class="gns panel-heading">Bu galeriyi paylaş</div>
<div class="panel-body">
...
<a class='blur' href="https://twitter.com/intent/tweet?url=<?php echo $mevcuturl; ?>&text=<?php echo $gbilgi["aciklama"]; ?>" onClick="return popup(this, 'notes')" rel='nofollow' target='_blank'><img title='twitter' border='0' height='36' src='<?php echo base_url(); ?>assets/resim/ticon.png' width='35'/></a>
...
<a class='blur' href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $mevcuturl; ?>title=<?php echo $gbilgi["baslik"]; ?>" onClick="return popup(this, 'notes')"  rel='nofollow' target='_blank'><img title='linkenldn' border='0' height='35' src='<?php echo base_url(); ?>assets/resim/lind.png' width='35'/></a>
...
<div class="kl panel-heading">Resim galerisi hakkında yorum yap</div>
<div class="panel-body">
<div class="yorumyap">
<form action="yorumyap" method="post" id="yorumform">
<div class="alert alert-info col-md-12" id="ybilgi" style="display:none"></div>
<input type="hidden" name="yaziid" value="<?php echo $gbilgi["id"]; ?>" />
<?php
...
<li id='<?php echo $yorum["id"]; ?>' class="<?php echo $gbilgi["id"]; ?>"><div class="media col-md-12 yorum">
<?php if($yorum["ses"]=="0"){ ?>
...
<div class="kl panel-heading">Benzer resim galerileri</div>
<div class="panel-body">
...
<div id="bnbox">
 <a href='<?php echo base_url(); ?>galeri/<?php echo $benzer["id"]; ?>'> <img src='<?php echo $benzer["resimurl"]; ?>' id="benzerresim" alt="resim"/>
<h3 id="bnbaslik"><?php echo $benzer["baslik"]; ?></h3></a>
</div>
</div>
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/kapla.css" />
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/kapla.js"></script>
<div class="kl panel-heading">En çok bakılan galeriler</div>
<div class="panel-body">
