...
$hcek = $db->query("Select * from resimgaleri where id<$id order by id desc limit 5 ");
...
<a target="_blank" href='/pro/r/<?php echo $sonuc["id"]; ?>'>	<img src='<?php echo $sonuc["resimurl"]; ?>' alt='resim' id="rhbrresim"/>	
</a>
