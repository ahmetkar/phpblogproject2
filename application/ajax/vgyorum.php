...
$hcek = $db->query("Select * from vgyorum where id<$id && vgaleriid=$hid && onay=1 order by id desc limit 5 ");
...
if($hcek->rowCount()!=0){	
	...
	?>
	<li id='<?php echo $yorum["id"]; ?>' class="<?php echo $yorum["vgaleriid"]; ?>"><div class="media col-md-12 yorum">
