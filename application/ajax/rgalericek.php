...
$hcek = $db->query("Select * from resimgaleri where id<$id order by id desc limit 8 ");
...
if($hcek->rowCount()!=0){	
	...
	<a target="_blank" href='/pro/galeri/<?php echo $galeri["id"]; ?>'>	<img src='<?php echo $galeri["resimurl"]; ?>' alt='resim' id="hbrresim"/>	
	</a>
	<div id="detay">
	<a target="_blank" href='/pro/galeri/<?php echo $galeri["id"]; ?>'>
